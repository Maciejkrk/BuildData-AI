...
class ConverterTests(unittest.TestCase):
    ...
    def test_web_ui_has_product_variant_row_rules_and_hidden_rule_rows(self):
        ...
        self.assertIn("id=\"productModelFiles\"", html)
        ...
        self.assertIn("name=\"product_model_files\"", html)
    ...
    def test_building_elements_ui_explains_product_identity(self):
        ...
        self.assertIn('id="elementProductModelFiles"', html)
        ...
        self.assertIn("systems_count_is_exact", html)
        self.assertIn("Element ${currentOffset + 1}", html)
        self.assertIn("lastElementPreview?.quality || {}", html)
        self.assertIn('form.append("preview_offset"', html)
        self.assertIn('form.append("preview_limit", "1")', html)
        self.assertIn("quality.has_next", html)
        self.assertIn("renderElementVisualPreview", html)
        self.assertIn("element-visual-card", html)
